...
export const DMC_COLORS = [
  ...
  { dmc: '321', name: 'Christmas Red / Buckeye', hex: '#C8102E' },
  { dmc: '666', name: 'Bright Red', hex: '#E60026' },
  { dmc: '304', name: 'Red Med / UGA-ish', hex: '#B6022C' },
  { dmc: '498', name: 'Red Dk', hex: '#A0001A' },
  { dmc: '816', name: 'Garnet / USC-ish', hex: '#900020' },
  { dmc: '815', name: 'Garnet Med / Bama Crimson', hex: '#8B0014' },
  ...
  { dmc: '947', name: 'Burnt Orange / Auburn', hex: '#F47D30' },
  { dmc: '946', name: 'Burnt Orange Med / UT', hex: '#E55B16' },
